...
export const TASKS_SPECS: ActionSpec[] = [
  ...
  { id: "tasks.enter", keys: ["Enter"], desc: "Inspect the session in a modal; on a feature header: open feature actions (review/merge, force merge, blocked inspector)", hint: "Actions", group: "tasks", when: listOnly },
