...
export const TASKS_SPECS: ActionSpec[] = [
  ...
  { id: "tasks.enter", keys: ["Enter"], desc: "Inspect the session in a modal; on a feature header: collapse/expand (persists per project)", hint: "Open", group: "tasks", when: listOnly },
