			...
			r.Route("/tasks", func(r chi.Router) {
				...
				r.Group(func(r chi.Router) {
					...
					if o.handler != nil && o.handler.runner != nil {
						...
						r.Post("/runner/features/pause/{projectId}/{featureId}", o.handler.HandlePauseFeatureDispatch)
						r.Post("/runner/features/resume/{projectId}/{featureId}", o.handler.HandleResumeFeatureDispatch)
						...
						r.Post("/runner/features/pause/{projectId}/{featureId}", notImplemented)
						r.Post("/runner/features/resume/{projectId}/{featureId}", notImplemented)
