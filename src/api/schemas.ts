...
export const BrainEntrySchema = z.object({
  ...
  parent_id: EntryIdSchema.optional().openapi({ description: "Parent entry ID for hierarchical grouping" }),
...
export const CreateEntryRequestSchema = z.object({
  ...
  parent_id: EntryIdSchema.optional(),
...
export const ResolvedTaskSchema = TaskSchema.extend({
  ...
  parent_chain: z.array(EntryIdSchema).openapi({ description: "IDs of all ancestors" }),
