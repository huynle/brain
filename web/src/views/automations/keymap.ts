...
export const AUTOMATIONS_SPECS: ActionSpec[] = [
  ...
  { id: "automations.open", keys: ["o", "O"], desc: "Open run-task in the Control tab (live console / resume)", hint: "Open", group: "automations", when: listOnly },
  { id: "automations.enter", keys: ["Enter"], desc: "Inspect run session (modal) / expand automation / configure goal", hint: "Expand", group: "automations", when: listOnly },
