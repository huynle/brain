...
func brainEntryToResolvedTask(task *types.BrainEntry) types.ResolvedTask {
	return types.ResolvedTask{
		...
		MachineAffinity:         task.MachineAffinity,
		...
		ResumeInjectedContext:   task.ResumeInjectedContext,
		ResumePreferSameSession: task.ResumePreferSameSession,
		ResumeExecutorOverride:  task.ResumeExecutorOverride,
