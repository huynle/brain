...
- [ ] Step 1: Read task with `recall(path: "<task-path>")`
- [ ] Step 2: Mark as in_progress with `update(path: "...", status: "in_progress")`
- [ ] Step 3: Triage complexity (Route A/B/C)
- [ ] Step 4: Append triage decision with `update(path: "...", append: "## Triage\n...")`
...
- [ ] Step 11: Complete task with `update(path: "...", status: "completed", append: "## Summary\n...\n\n**Commit:** <hash>")`
...
1. Mark task as blocked: `update(path: "...", status: "blocked", note: "...")`
...
**If blocked:**
- Mark task as blocked with `update`
