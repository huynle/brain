...
describe('useMultiProjectPoller - multiProjectReducer', () => {
  ...
  it('should handle FETCH_SUCCESS with all project data in a single state object', () => {
    const tasksByProject = new Map([['p1', [{ id: 't1', path: '/p', title: 'T1', status: 'pending' as any, priority: 'medium' as any, children_ids: [] as string[] }]]]);
  ...
  describe('mergeAllTasks', () => {
    ...
    it('should merge tasks from multiple projects into a flat array', () => {
      const tasksByProject = new Map([
        ['p1', [
          { id: 't1', path: '/p', title: 'T1', status: 'pending' as any, priority: 'medium' as any, children_ids: [] as string[], projectId: 'p1' },
        ]],
        ['p2', [
          { id: 't2', path: '/p', title: 'T2', status: 'completed' as any, priority: 'low' as any, children_ids: [] as string[], projectId: 'p2' },
        ]],
      ]);
